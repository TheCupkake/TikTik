      ...
      <div className="flex gap-6 md:gap-10 mb-4 bg-white w-full">
        <div className="w-16 h-16 md:w-32 md:h-32">
          ...
          />
              ...
              <div className=" xl:block flex flex-col justify-center">
                <p className="md:text-2xl tracking-wider  flex gap-1 justify-center items-center text-md font-bold text-primary lowercase">{user.userName.replaceAll(' ', '')} <GoVerified className="text-blue-400" /></p>
